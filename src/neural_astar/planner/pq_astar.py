...
def pq_astar(
    ...
    pred_costs_np = pred_costs.detach().cpu().numpy()
    start_maps_np = start_maps.detach().cpu().numpy()
    goal_maps_np = goal_maps.detach().cpu().numpy()
    map_designs_np = map_designs.detach().cpu().numpy()
